...
const resources = {
    en: {
        translation: {
            ...
            about: "About",
            start: "Start Now!",
            home_title1: "Introducing Elite Talent Connect: Your Gateway to Premium Career Opportunities in the DMV Region",
            home_body1: "At Elite Talent Connect, we specialize in empowering professionals like you to discover exceptional career prospects in the dynamic DMV area.With a legacy of over 25 years, we have honed the art of seamlessly bridging the gap between top - tier employers and highly qualified candidates.",
            home_title2: "Our Unparalleled Network of Opportunities",
            ...
            home_title3: "Unearthing Unique Career Avenues",
            home_body3: "Elite Talent Connect goes beyond the ordinary.We specialize in connecting candidates with opportunities that often fly under the radar of traditional agencies.Whether you aspire to join the elite ranks of IT, cybersecurity, diesel tech, app development, or gaming professionals, we provide comprehensive support for a diverse range of roles, including:",

            home_body4: "We understand that many individuals who are an ideal fit for these roles lack the insider knowledge and representation needed to excel in today's competitive job market. That's where Elite Talent Connect steps in.",
            home_body5: "Our commitment is to empower you with the insights, connections, and support necessary to thrive in your chosen field.Welcome to a world of exclusive opportunities where your unique skills and expertise are truly valued.",
            home_body6: "Unlock your potential with Elite Talent Connect.Discover your future in the DMV area today.",
            career_1: "IT Specialists",
            career_2: "Cybersecurity Experts",
            career_3: "Diesel Technicians",
            career_4: "App Developers",
            career_5: "Gaming Industry Pioneers",
            career_6: "Warehouse Professionals",
            career_7: "Maintenance Specialists",
            career_8: "Restaurant and Hotel Personnel",
            career_9: "Customer Service Champions",
            career_10: "Skilled Drivers",
            career_11: "Construction Experts",
            career_12: "Entry - Level Office Professionals",
    ...
    es: {
        translation: {
            ...
            home_title1: "Presentamos Elite Talent Connect: su puerta de entrada a oportunidades de carrera premium en la región de DMV",
            home_body1: "En Elite Talent Connect, nos especializamos en capacitar a profesionales como usted para descubrir perspectivas profesionales excepcionales en el dinámico área de DMV. Con un legado de más de 25 años, hemos perfeccionado el arte de cerrar la brecha entre los empleadores de primer nivel y los candidatos altamente calificados.",
            home_title2: "Nuestra red incomparable de oportunidades",
            home_body2: "Hemos cultivado fuertes asociaciones con un selecto grupo de prestigiosos empleadores de DMV que confían exclusivamente en nuestros servicios para identificar y asegurar talentos de primer nivel para sus organizaciones. Nuestra larga trayectoria les asegura que entregamos los candidatos más calificados para sus vacantes críticas.",
            home_title3: "Descubriendo avenidas de carrera únicas",
            home_body3: "Elite Talent Connect va más allá de lo ordinario. Nos especializamos en conectar candidatos con oportunidades que a menudo pasan desapercibidas para las agencias tradicionales. Ya sea que aspire a unirse a las filas de élite de TI, ciberseguridad, tecnología diesel, desarrollo de aplicaciones o profesionales de juegos, brindamos un soporte integral para una amplia gama de roles, incluidos:",
            home_body4: "Entendemos que muchas personas que son ideales para estos roles carecen del conocimiento interno y la representación necesarios para sobresalir en el competitivo mercado laboral actual. Ahí es donde entra Elite Talent Connect.",
            home_body5: "Nuestro compromiso es capacitarlo con los conocimientos, conexiones y el apoyo necesarios para prosperar en el campo elegido. Bienvenido a un mundo de oportunidades exclusivas donde sus habilidades y experiencia únicas son realmente valoradas.",
            career_1: "Especialistas en TI",
            career_2: "Expertos en ciberseguridad",
            career_3: "Técnicos diesel",
            career_4: "Desarrolladores de aplicaciones",
            career_5: "Pioneros de la industria de los juegos",
            career_6: "Profesionales de almacén",
            career_7: "Especialistas en mantenimiento",
            career_8: "Personal de restaurantes y hoteles",
            career_9: "Campeones de servicio al cliente",
            career_10: "Conductores calificados",
            career_11: "Expertos en construcción",
            career_12: "Profesionales de oficina de nivel de entrada",
